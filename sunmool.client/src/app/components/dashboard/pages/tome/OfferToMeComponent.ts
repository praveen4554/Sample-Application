...
@Component({
  ...
  styleUrls: ['./src/app/components/dashboard/pages/tome/OfferToMe.css'],
  templateUrl: './src/app/components/dashboard/pages/tome/OfferToMe.html',
})
export class OfferToMeComponent {
